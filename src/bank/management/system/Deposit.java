        ...
        try {
            ...
            if (ae.getSource() == b1) {
                if (amount.equals("")) {
                    ...
                    // Validate if deposit is a positive amount
                    if (depositAmount <= 0) {
                        JOptionPane.showMessageDialog(null, "Amount must be a positive number");
                    }
                    // Validate if deposit exceeds the limit of ₹50,000
                    else if (depositAmount > 50000) {
                        JOptionPane.showMessageDialog(null, "Deposit amount cannot exceed ₹50,000");
                    } else {
                        Conn c1 = new Conn();
