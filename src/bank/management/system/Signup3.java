...
public class Signup3 extends JFrame implements ActionListener {
    ...
    if (ae.getSource() == b2) {
        // If the cancel button is clicked, exit without any validations
        System.exit(0);
    }
    ...
    if (atype == null) {
        JOptionPane.showMessageDialog(null, "You must select an account type.");
        return;
    }
    ...
    String pin = String.format("%04d", Math.abs(first3));
