    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            if (ae.getSource() == b1) {
                ...
                // Validation for Card No
                if (cardnumber.isEmpty()) {
                    JOptionPane.showMessageDialog(null, "Card Number field cannot be empty.");
                    return;
                } else if (!cardnumber.matches("\\d{16}")) {
                    JOptionPane.showMessageDialog(null, "Card Number must be exactly 16 digits long and contain only numbers.");
                    return;
                }
